                        ...
                        <div className="lg:w-3/4 md:w-2/3 md:px-3 mt-[30px] md:mt-0">
                            <div className="pb-6 border-b border-gray-100 dark:border-gray-700">
                                ...
                                <p className="text-slate-400 mt-3">
                                    address: {userList?.address?.address} city:{" "}
                                    {userList?.address?.city} postalCode:{" "}
                                    {userList?.address?.postalCode}
                                </p>
                            </div>
                                        ...
                                        <div className="flex-1 content ml-4">
                                            ...
                                            <p className="text-indigo-600 mb-0">
                                                <span>
                                                    Address :{" "}
                                                    <span className="text-slate-400">
                                                        {userList?.company?.address?.address}
                                                    </span>
                                                </span>
                                            </p>
                                            <p className="text-indigo-600 mb-0">
